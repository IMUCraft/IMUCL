  ...
  const aboutSettingGroups: OptionItemGroupProps[] = [
    {
      ...
      items: [
        ...
        {
          title: t("AboutSettingsPage.about.settings.aboutIMU.title"),
          children: (
            <CommonIconButton
              label="https://docs.imucraft.cn/"
              icon="external"
              withTooltip
              tooltipPlacement="bottom-end"
              size="xs"
              h={18}
              onClick={() => {
                openUrl("https://docs.imucraft.cn/");
              }}
            />
          ),
        },
      ...
      items: [
        ...
        },
        {
          ...
          children: (
            <CommonIconButton
              label={t(
                "AboutSettingsPage.legalInfo.settings.IMUuserAgreement.url"
              )}
              icon="external"
              withTooltip
              tooltipPlacement="bottom-end"
              ...
              onClick={() => {
                openUrl(
                  t("AboutSettingsPage.legalInfo.settings.IMUuserAgreement.url")
                );
              }}
            />
          ),
